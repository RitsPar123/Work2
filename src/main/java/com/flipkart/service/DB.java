...
public class DB{
    ...
    int limit2=2;
    static HashMap<Integer,String> orderDetails=new HashMap<Integer,String>();
    static HashMap<Integer,String> doctorDetails=new HashMap<Integer,String>();

    static User dummyUser=new User(-1,"abc","123",500345);
